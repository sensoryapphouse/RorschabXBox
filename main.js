...
//            gl = canvas.getContext("experimental-webgl", {preserveDrawingBuffer: true});
    ...
    function initShaders() {
        ...
        programsArray.push(createProgram("shader-vs", "shader-9-fs"));
        programsArray.push(createProgram("shader-vs", "shader-10-fs"));
        programsArray.push(createProgram("shader-vs", "shader-11-fs"));
        programsArray.push(createProgram("shader-vs", "shader-12-fs"));
        programsArray.push(createProgram("shader-vs", "shader-13-fs"));
        programsArray.push(createProgram("shader-vs", "shader-14-fs"));
        programsArray.push(createProgram("shader-vs", "shader-15-fs"));
...
var mouseState = 0;
     function MonitorMouseDown(e) {
      if (!e) e=window.event;
        ...
        c.style.filter = "hue-rotate(" + 360.*mouseX + "deg)";
         toggleButtons();
      return false;
    }
